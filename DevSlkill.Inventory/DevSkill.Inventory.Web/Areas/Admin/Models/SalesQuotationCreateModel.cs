...
{
    public class SalesQuotationCreateModel
    {
        ...
        public SalesQuotationCreateModel()
        {
            ...
            // A new offer is either kept as a draft or handed to the customer straight
            // away. Accepting and rejecting are the customer's answer, not a state to
            // be typed in here.
