...
namespace DevSkill.Inventory.Infrastructure.Repositories
{
    public class WarrantyRepository : Repository<Warranty, Guid>, IWarrantyRepository
    {
        ...
        public async Task<(IList<Warranty> data, int total, int totalDisplay)> GetPagedWarrantiesAsync(int pageIndex, int pageSize, DataTablesSearch search, string? order)
        {
